    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            instructions=textwrap.dedent(
                ...
                EXPRESSIVENESS: shape your delivery with Fish Audio's bracket markers. They're spoken cues, not text — the frontend hides anything in [square brackets], so they never show up in the transcript. Write every marker as a BARE bracket, e.g. [excited] — never wrap a marker (or anything else) in backticks, asterisks, or quotes, and never use markdown of any kind. You are a voice: emit plain spoken text only. (The examples below show markers in `backticks` purely for readability here; do not copy the backticks into your replies.)
